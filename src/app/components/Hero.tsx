  ...
  return (
    <div className="relative w-full bg-[#F3F3F3] overflow-hidden flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="w-full md:w-1/2 h-full flex flex-col md:flex-row items-center justify-start pl-6 md:pl-16 relative">
        ...
        {/* Bulb Image */}
<div className="relative md:absolute top-[-110px] left-[-50px]">
  <Image src="/bulb.png" alt="Bulb" width={300} height={100} className="object-contain" />
</div>


        {/* Text Content - Aligning next to the bulb */}
        <div className="relative mt-20 md:mt-0 md:ml-20 text-center md:text-center">
          {/* Pink Text */}
      ...
      <div className="w-full md:w-1/2 h-full relative flex flex-col items-center justify-start">
        ...
        {/* Blue Discount Badge */}
        <div
          className="absolute top-[40px] right-[240px] bg-cover bg-center w-[80px] h-[80px] flex flex-col justify-center items-center z-20"
